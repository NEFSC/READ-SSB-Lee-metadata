...
+ The CATCH_ID is unique to the "SPPCODE- DEALNUM-dealergear-mesh-area" fished.
...
## General Caveats. very incomplete.
* 1994-1995 are kind of sketchy

* Electronic VTRs have very long serial numbers.  Some software doesn't like this (Excel, stata) -- you might want to do this:```select to_char(g.serial_num) from veslog2014g g```
...
* CAREA, CNEMAREA, CLATDEG, CLATMIN, CLATSEC, CLONDEG, CLONMIN, CLONSEC, CERRNO, AREA_IND, TENMSQ
    ...
    + "NEMAREA" includes "inshore areas"
        + The latitude and longitude points reported on a VTR are first binned into a Ten Minute Square.
        + These binned squares are then checked against a lookup table that converts Ten Minutes Squares into statistical areas [LOC2AREAS]. 
...
## Sample Projects very incomplete.

## Update Frequency and Completeness very incomplete.
...
+ VLSPP,SPECIES_ITIS_NE decodes SPPCODES into names
