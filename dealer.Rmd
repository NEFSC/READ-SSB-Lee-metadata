...
* There are a couple of species that have two NESPP3 codes. 
    + Cod (080, 081) 
    + Monkfish (011, 012).  

* Some species were/are lumped together. 
...
## Sample Projects
+ Construct prices for fish [Lee, Demarest].
+ Commercial Landings and Revenues for the “Community Profiles.” [Olson, Colburn]
+ “The record” of commercial landings for use in stock assessment. [PopDy]
