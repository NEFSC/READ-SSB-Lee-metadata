...
This compiles to pdf (needs pdflatex in TexLive or MikTex).   
This will also compile to html and docx.  docx is the ugliest.  HTML is reasonable.
...
\begin{figure}[htbp]
\begin{centering}
\includegraphics[width=.8\textwidth]{sql.png}
\caption{An illustration of looking at the underying SQL code that generates a view.\label{sql_picture}}
\end{centering}
\end{figure}
...
**This is a partially complete. Let's call it 6 out of 10. **
...
# MQRS Databases
**This is mostly a placeholder. Let's call it 2 out of 10. **
