...
## Overview
The MQRS system is fun. It contains information on "eligibilities."  The sector rosters are also stored here.
...
This is happening in part because the underlying code forgot to screen for valid dates.
  ...
  * There have been "clean ups" -- sometimes an entry gets put into the MQRS database where the DATE_ELIGIBLE is equal to the DATE_CANCELLED. This may cause mis-merges.  You also may want to exclude these completely from your query.
    ```
...
```
  ...
  * History Retention and CPH are synonyms. 
